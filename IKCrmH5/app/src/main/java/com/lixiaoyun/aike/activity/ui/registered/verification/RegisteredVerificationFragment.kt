...
import com.lixiaoyun.aike.activity.ui.registered.confirm.RegisteredConfirmFragment
...
import kotlinx.android.synthetic.main.fragment_registered_verification.*

class RegisteredVerificationFragment : Fragment(), VerificationContract.View, TextWatcher {
    ...
    companion object {
        fun newInstance() = RegisteredVerificationFragment()
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_registered_verification, container, false)
    }
    ...
    private fun initListener() {
        ...
        vEtUsername.run {
            ...
            addTextChangedListener(this@RegisteredVerificationFragment)
        }
    ...
    override fun nextPage(userToken: String, phoneNumber: String) {
        activity?.run {
            supportFragmentManager.beginTransaction()
                    .replace(R.id.container, RegisteredConfirmFragment.newInstance(phoneNumber, userToken))
